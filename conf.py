...
BLOG_AUTHOR = "Nicholas H.Tollervey"  # (translatable)
BLOG_TITLE = "The CodeGrades Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.codegrades.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "hello@codegrades.com"
BLOG_DESCRIPTION = "Articles and news about CodeGrades."  # (translatable)
...
TWITTER_CARD = {
    ...
    'site': '@codegrades',         # twitter nick for the website
    'creator': '@codegrades',     # Username for the content creator / author.
}
